...
export function isDirectiveClass(
  ...
  return typeof value === 'function' && value.prototype instanceof Directive;
}

export function hasReactivity(): boolean {
  return typeof MiniQuery.isSignal === 'function';
}
 ...
 */
export function isReactiveSource<T = any>(
  value: unknown,
): value is {
  subscribe: (cb: (v: T) => void) => () => void;
  getValue?: () => T;
} {
  return typeof MiniQuery.isSignal === 'function' && MiniQuery.isSignal(value);
}
