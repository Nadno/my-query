...
import { CustomEventFactory, CustomEventListener } from '../custom-events';
...
> = ({ handler, target, args = [], getContext, dispose }) => {
  ...
  if (delegationTarget) {
    ...
    return {
      ...
      adder([mouseMoveEvent, mouseOutEvent], [handleMouseOver, handleMouseOut], options) {
      ...
      remover([mouseMoveEvent, mouseOutEvent], [handleMouseOver, handleMouseOut], options) {
  ...
  return {
    ...
    adder([mouseOverEvent, mouseOutEvent], [handleMouseOver, handleMouseOut], options) {
      target.addEventListener(mouseOverEvent, handleMouseOver, options);
      target.addEventListener(mouseOutEvent, handleMouseOut, options);
    },
    remover([mouseOverEvent, mouseOutEvent], [handleMouseOver, handleMouseOut], options) {
